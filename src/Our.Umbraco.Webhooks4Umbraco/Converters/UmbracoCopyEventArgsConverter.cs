...
{
    public abstract class UmbracoCopyEventArgsConverter<TEntity> : ArgTypeConverter
    {
        public override string Key
        {
            get
            {
                return "copiedEventArgs";
            }
        }

        public override bool CanConvertFrom(ITypeDescriptorContext context, Type sourceType)
        {
            return sourceType == typeof(CopyEventArgs<TEntity>);
        }

        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            var typedValue = (CopyEventArgs<TEntity>)value;
            if (typedValue == null) return null;

            return new
            {
                entity = this.ConvertFrom(context, culture, typedValue.Copy)
            };
        }
    ...
    public class UmbracoContentCopyEventArgsConverter : UmbracoCopyEventArgsConverter<IContent>
    {
    ...
    public class UmbracoMediaCopyEventArgsConverter : UmbracoCopyEventArgsConverter<IMedia>
    {
